" NOTE: This file is a direct copy of the syntax file from direnv/direnv.vim
" Source: https://github.com/direnv/direnv.vim/blob/master/syntax/direnv.vim
" If you need updates, check the upstream repository.
